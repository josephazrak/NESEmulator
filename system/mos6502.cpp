...
uint8_t MOS6502::IMM()
{
    // In this addressing mode, the address to fetch is usually immediately after the
    // instruction (located @ PC). As such, increment PC and fetch the byte at PC.

    PC += 1;
    fetched = NES_Ram.read_byte(PC);
